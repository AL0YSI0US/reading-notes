...
| **Term** | **Contents** |
| :-: | - |
| body | this is where the content of a page goes |
| head | title, link CSS, link JavaScript, meta, sizing data |
| doctype | tells the browser what it is reading and what to expect such as HTML |
